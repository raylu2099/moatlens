...
- analyze(): standard audit stage analysis (sonnet-4-6)
...
# Per-million-token pricing (Anthropic API, standard ≤200K context), verified 2026-06.
# Opus 4.5+ is $5/$25 — NOT the old $15/$75 Claude-3 era. Keep accurate so
# data/metrics/cost.jsonl reflects real spend if CLAUDE_MODEL is bumped to Opus.
PRICING = {
